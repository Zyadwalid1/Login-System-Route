...
finishButton.addEventListener("click", function () {
  ...
  swal.fire({
    ...
    imageUrl: "images/grinning-face_1f600.png",
...
continueButton.addEventListener("click", function () {
  switch (validation()) {
    ...
    case "userEmail is false":
      birdImage.setAttribute("src", "images/pouting-face_1f621.png");
...
loginSwitchButton.addEventListener("click", function () {
  ...
  if (
    ...
    birdImage.setAttribute("src", "images/saluting-face_1fae1.png");
